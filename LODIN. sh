# A tool by nitro from www.lodin-Hacker.com
...
echo -e "$red                      ⫸$ylo  Lodin Hacker$red ⫷$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https://Lodin-Hacker.github.io/Lodinspage > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
echo -e "\e[93m             IAM FROM \e[92mLodin Hacker" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.Lodin-Hacker.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Lodin-Hacker/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://Lodinhacktube.com 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
